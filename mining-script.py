...
def fetchBugCommentsLog(jira: JIRA, project: str, manager: str, category: str, issue_key: str) -> list:
    events = []
...
def fetchBugCommitLog(project: str, manager: str, category: str, bug_key: str, commit: Commit) -> list:
    events = []
